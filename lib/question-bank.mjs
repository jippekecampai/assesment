...
function build({ domain, type, prompt, options, answer, source = 'Handmatig', approvedBy = '', uitleg = '' }) {
  return { id: randomUUID(), domain, type, prompt, options, answer, uitleg, source, approvedBy, approvedAt: new Date().toISOString() };
}
