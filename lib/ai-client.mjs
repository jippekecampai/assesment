...
function buildPrompt(domain, count) {
  return `Genereer ${count} hoogwaardige Nederlandstalige meerkeuzevragen voor een MSP-recruitmentassessment, domein "${domain}". `
    ...
    + `CRUCIAAL tegen gokken: de vier opties moeten ONGEVEER EVEN LANG zijn (langste optie hooguit 1,4x de kortste) en het juiste antwoord mag NIET stelselmatig het langste of meest gedetailleerde zijn; varieer de positie en laat het juiste antwoord regelmatig even kort of korter zijn dan de afleiders. Stop dus niet alle nuance/stappen alleen in het juiste antwoord. `
