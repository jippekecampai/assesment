...
export const testQuestions = [
  ...
  // ── Engels ───────────────────────────────────────────────────────────────
  {
    ...
    options: [
      "Service has been fully resolved and you will not experience any further issues at all.",
      ...
      "Service should be working again now, and we will let you know if anything changes on our side.",
      "Service is back and the issue appears to have started outside our environment, so it should be stable.",
    ],
    answer: 1,
  },
  {
    ...
    options: [
      "I am very sorry about this and I promise it will be completely fixed by the end of the day.",
      ...
      "I am sorry for the delay; we are looking into it and will get back to you as soon as we can.",
      "I am sorry about this; the delay is mainly due to a dependency on another team's input.",
    ],
    answer: 1,
  },
  {
    ...
    options: [
      "Enabling MFA means your account will be completely safe and can no longer be hacked.",
      ...
      "It is an extra security step we are rolling out for everyone, so please enable it when you get the prompt.",
    ],
    answer: 1,
  },
  {
    ...
    options: [
      "Could you send me all the details you have so I can look into it as quickly as possible?",
      "To investigate this further, could you let me know when the issue started and share a screenshot of the error message?",
      "Could you describe the problem in a bit more detail so I have something to work with?",
      "If you can send a screenshot, I should be able to resolve this for you straight away.",
    ],
    answer: 1,
  },
  {
    ...
    options: [
      "That all sounds clear to me, I will go ahead and take care of it right away.",
      "Just to make sure I understand correctly, could you confirm whether you need X or Y before I proceed?",
      "I think I follow, but could you put the request in an email so I have it in writing as well?",
      "I have a rough idea of what you need, so I will make a start and check back with you afterwards.",
    ],
    answer: 1,
  },
];
