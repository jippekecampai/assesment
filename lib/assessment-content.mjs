...
export const testQuestions = [
  ...
  },
  {
    ...
    options: [
      "DKIM inschakelen in M365, de DKIM-CNAME's in DNS publiceren en de werking verifiëren, en daarna pas een DMARC-record toevoegen — DMARC kan alleen handhaven als DKIM en SPF correct uitlijnen",
      "Direct een DMARC-record op handhaving publiceren; zodra dat live staat dwingt DMARC de juiste DKIM- en SPF-uitlijning vanzelf af",
      "Het SPF-record uitbreiden met de DKIM-selectors en daarmee volstaan, omdat SPF daarmee ook DKIM afdekt",
      "Eerst DMARC op handhaving zetten en daarna pas DKIM activeren, zodat de afdwinging meteen actief is",
    ],
    answer: 0,
  },
  {
